...
Would a 20-minute call on how you're thinking about senior hires this year be worth a short slot? Happy to work around you.
...
- **Personalization basis (hooks used):**
  ...
  - recent_activity (conf 0.90)
  - industry (conf 0.90)
  - hiring_signal (conf 0.85)
- **Hooks dropped (below confidence threshold):**
  - Co-founded Northpoint Pay in 2019; (conf 0.60)
